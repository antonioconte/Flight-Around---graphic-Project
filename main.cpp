...
static int keymap[Controller::NKEYS] = {SDLK_a, SDLK_d, SDLK_w, SDLK_s};
  ...
  if (!LoadTexture(0,(char *)"assets/logo.jpg")) return 0;
  if (!LoadTexture(1,(char *)"assets/envmap_flipped.jpg")) return 0;
  if (!LoadTexture(2,(char *)"assets/sky_ok.jpg")) return -1;
